...
public class RecyclerViewAdapterHorizontal  extends RecyclerView.Adapter<RecyclerViewAdapterHorizontal.ItemViewHolder>
{
    private Context activity_context;
    private ArrayList<RecyclerViewItemModel> recyclerViewItemModelArrayList;

    public RecyclerViewAdapterHorizontal(Context context,ArrayList<RecyclerViewItemModel> recyclerViewItemModelArrayList)
    {
    ...
    {
        View view = LayoutInflater.from(activity_context).inflate(R.layout.recycler_view_item_row_horizontal, parent, false);
